// DOM Elements
    ...
    const formMapping = document.getElementById('formMapping');
	...
	formMapping.addEventListener('submit', function(event) {
		event.preventDefault();
		const newMapping = inputMapping.value;
		console.log('New mapping:', newMapping);
		writeModeCharacteristic(newMapping);
		formMapping.reset();
	});
